...
% Last Modified by GUIDE v2.5 28-May-2022 17:19:48
...
set(handles.edit1,'String',kontras);
set(handles.edit5,'String',korelasi);
set(handles.edit6,'String',energi);
set(handles.edit7,'String',homogenity);
set(handles.edit8,'String',Total);

Total = (mean(str2double(energi))+mean(str2double(homogenity)))/2;
if(Total <= 0.6)
    set(handles.tekstur,'String','Tidak Pakai Masker');
end
if(Total >= 0.62)
    set(handles.tekstur,'String','Pakai Masker');
end;
